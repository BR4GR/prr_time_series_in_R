...
kombiniert_desk <- bind_cols(desk_daten_sp500, desk_daten_rate$Werte) %>%
  setNames(c("Statistik", "S&P 500", "Leitzins")) %>% kbl(
      align = "lccc",
      escape = FALSE,
      full_width = FALSE) %>% 
